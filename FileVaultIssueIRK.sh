...
PROMPT_MESSAGE="Your Mac's FileVault encryption key needs to be re-generated and escrowed.
Click the Next button below, then enter your password when prompted."
...
Please contact the MacSupport for help with your Mac password."
...
FAIL_MESSAGE="Sorry, an error occurred while escrowing your FileVault key. Please contact the MacSupport for help."
